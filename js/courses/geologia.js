export const CURRICULUM = [
  {
    id: 'geo-mod-1',
    title: 'Rocas ígneas',
    description: 'Formación por enfriamiento de magma o lava',
    lessons: [
      {
        id: 'geo-l001',
        ...
        example: {
          title: 'Ejemplo: Magma vs lava',
          content: `<p>El granito de Yosemite cristalizó lentamente mostrando cristales visibles.</p>`,
          tip: 'Cristales grandes indican enfriamiento lento bajo tierra.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre magma vs lava.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dónde cristaliza más lentamente?',
              options: [
                'En erupciones instantáneas',
                'En el espacio',
                'Solo en glaciares',
                'Bajo la superficie',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Textura vítrea',
          content: `<p>La obsidiana se usó históricamente para filos de herramientas.</p>`,
          tip: 'Bordes de obsidiana son muy afilados: usa guantes.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre textura vítrea.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué textura indica enfriamiento instantáneo?',
              options: [
                'Clástica sedimentaria',
                'Metamórfica bandeada',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Basalto columnar',
          content: `<p>Giant's Causeway es ejemplo clásico de columnas basálticas.</p>`,
          tip: 'Grietas de enfriamiento suelen formar ángulos de ~120°.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre basalto columnar.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué forma las columnas hexagonales?',
              options: [
                'Raíces de plantas',
                'Contracción térmica al enfriar',
                'Erosión eólica sola',
                'Depósito de calcita',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Granito plutónico',
          content: `<p>Sierra Nevada expone batholitos graníticos por erosión profunda.</p>`,
          tip: 'El cuarzo resiste erosión y enriquece arenas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre granito plutónico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mineral que distingue granito de basalto?',
              options: [
                'Cuarzo y feldespato abundantes',
                'Solo carbonatos',
                '100% vidrio',
                'Fósiles marinos',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Piroclastos',
          content: `<p>Capas de tefra datan erupciones en estratigrafía.</p>`,
          tip: 'Ceniza fina puede viajar miles de kilómetros.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre piroclastos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué son lapilli?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Rocas ultrabásicas',
          content: `<p>Oman tiene ofiolita: corteza oceánica emplazada en continente.</p>`,
          tip: 'Olivino verde indica composición mantélica.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre rocas ultrabásicas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mineral típico ultrabásico?',
              options: [
                'Halita',
                'Olivino',
                'Calcita',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Diques y sills',
          content: `<p>Contacto térmico puede crear hornfels en encajante.</p>`,
          tip: 'Dike negro en roca clara es muy visible.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre diques y sills.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué corta capas sedimentarias?',
              options: [
                'Sill paralelo',
                'Estrato conforme',
                'Horizonte de suelo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Índice de color',
          content: `<p>Basalto oscuro es básico; riolita clara es ácida.</p>`,
          tip: 'Meteorización oscurece rocas ácidas: no te fíes solo del color.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre índice de color.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Roca más rica en sílice?',
              options: [
                'Riolita',
                'Basalto',
                'Peridotita',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Calderas',
          content: `<p>Yellowstone es caldera activa con geotermia extensa.</p>`,
          tip: 'Lagos en calderas pueden acumular gases disueltos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre calderas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué forma una caldera?',
              options: [
                'Glaciación',
                'Colapso tras erupción mayor',
                'Solo erosión fluvial',
                'Depósito eólico',
              ],
              correct: 1,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Identificación en campo',
          content: `<p>Cuarzo raya vidrio; calcita burbujea con ácido.</p>`,
          tip: 'Registra GPS y foto de cada muestra.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre identificación en campo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Prueba para carbonato?',
              options: [
                'Sabor salado',
                'Fluorescencia UV',
                'Efervescencia con ácido diluido',
                'Imán potente',
              ],
              correct: 2,
            },
  ...
  },
  {
    ...
    description: 'Acumulación, litificación y registro de ambientes',
    lessons: [
      {
        id: 'geo-l011',
        ...
        example: {
          title: 'Ejemplo: Clasificación clástica',
          content: `<p>Cantos redondeados indican transporte prolongado en agua.</p>`,
          tip: 'Brecha tiene fragmentos angulares; conglomerado redondeados.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre clasificación clástica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Roca de grano más fino?',
              options: [
                'Conglomerado',
                'Brecha',
                'Grava suelta',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ambientes deposicionales',
          content: `<p>Ripple marks fosilizados indican corriente u oleaje.</p>`,
          tip: 'Fósiles reconstruyen paleoambiente mejor que color solo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ambientes deposicionales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué indican ripple marks?',
              options: [
                'Intrusión magmática',
                'Meteorización química',
                'Corriente u oleaje al depositarse',
                'Impacto meteorítico',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Rocas químicas',
          content: `<p>Death Valley tiene boratos y halita gema.</p>`,
          tip: 'Halita tiene sabor salado distintivo en muestras limpias.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre rocas químicas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Roca por evaporación?',
              options: [
                'Basalto',
                'Halita y yeso',
                'Granito',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Caliza y fósiles',
          content: `<p>Caliza cretácica puede contener rudistas.</p>`,
          tip: 'Caliza meteorizada forma suelos rojos ricos en hierro.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre caliza y fósiles.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Composición principal de caliza?',
              options: [
                'Carbonato de calcio',
                'Sílice pura',
                'Feldespato',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Discordancias',
          content: `<p>Siccar Point demostró tiempo geológico profundo.</p>`,
          tip: 'Un gap puede representar millones de años sin registro.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre discordancias.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Discordancia angular?',
              options: [
                'Dike basáltico',
                'Geoda',
                'Estratos inclinados sobre horizontales',
                'Capas paralelas continuas',
              ],
              correct: 2,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Transgresiones',
          content: `<p>Transgresión deposita lutitas sobre areniscas costeras.</p>`,
          tip: 'Secuencias fining-upward son comunes en deltas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre transgresiones.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Fining-upward indica?',
              options: [
                'Intrusión',
                'Grano más fino hacia arriba',
                'Erupción volcánica',
                'Impacto meteorítico',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Turbiditas',
          content: `<p>Secuencia de Bouma tiene intervalos Ta-Te.</p>`,
          tip: 'Deltas entregan gran parte del sedimento oceánico.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre turbiditas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Flujo turbidítico?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fosilización',
          content: `<p>Trilobites en pizarra muestran moldes detallados.</p>`,
          tip: 'No extraigas fósiles en sitios protegidos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fosilización.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mejor ambiente para fósiles?',
              options: [
                'Sedimentación rápida en agua tranquila',
                'Cima expuesta sin sedimento',
                'Lava recién solidificada',
                'Desierto sin cubierta',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Diagénesis',
          content: `<p>Cuarzo sobrecrece granos en arenisca madura.</p>`,
          tip: 'Roca cementada es más dura que sedimento fresco.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre diagénesis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Convierte arena en arenisca?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Muestreo estratigráfico',
          content: `<p>Etiqueta: fecha, UTM, estrato, litología.</p>`,
          tip: 'Foto con escala (martillo) es obligatoria.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre muestreo estratigráfico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dato esencial en cuaderno?',
              options: [
                'Nombre del coleccionista',
                'Temperatura ambiente',
                'Coordenadas y columna estratigráfica',
                'Solo color subjetivo',
              ],
              correct: 2,
            },
          ],
  ...
  },
  {
    ...
    description: 'Transformación por presión, temperatura y fluidos',
    lessons: [
      {
        id: 'geo-l021',
        ...
        example: {
          title: 'Ejemplo: Metamorfismo de contacto',
          content: `<p>Andalusita indica metamorfismo de baja presión.</p>`,
          tip: 'Hornfels es fino, duro y oscuro.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre metamorfismo de contacto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Causa metamorfismo de contacto?',
              options: [
                'Solo erosión glaciar',
                'Depósito fluvial',
                'Evaporación',
                'Intrusión magmática caliente',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Metamorfismo regional',
          content: `<p>Alpes muestran esquistos con minerales índice.</p>`,
          tip: 'Foliación puede ser sedimentaria o tectónica también.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre metamorfismo regional.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Roca con foliación regional?',
              options: [
                'Conglomerado',
                'Basalto vítreo',
                'Esquisto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Facies metamórficas',
          content: `<p>Serie de Barrow mapea zonas metamórficas.</p>`,
          tip: 'Minerales índice marcan grado creciente.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre facies metamórficas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mineral de alta presión?',
              options: [
                'Halita',
                'Kyanita',
                'Clorita',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Gneiss bandeado',
          content: `<p>Gneiss del Escudo Canadiense supera 3 Ga.</p>`,
          tip: 'Migmatita muestra fusión parcial.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre gneiss bandeado.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Banding en gneiss?',
              options: [
                'Segregación mineral en bandas',
                'Estratificación intacta',
                'Fósiles preservados',
                'Sal evaporada',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mármol y cuarcita',
          content: `<p>Mármol de Carrara es caliza metamorfoseada pura.</p>`,
          tip: 'Cuarcita resiste erosión química.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mármol y cuarcita.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Origen del mármol?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Pizarra y cleavage',
          content: `<p>Pizarra para tejados proviene de bajo grado metamórfico.</p>`,
          tip: 'Mica orientada da brillo en foliación.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre pizarra y cleavage.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Uso tradicional de pizarra fina?',
              options: [
                'Vidrio óptico',
                'Tejados y tableros',
                'Combustible fósil',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Milonitas',
          content: `<p>Cataclasita es equivalente frágil superficial.</p>`,
          tip: 'Slickensides indican movimiento.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre milonitas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué es milonita?',
              options: [
                'Fósil índice',
                'Concreción de hierro',
                'Geoda',
                'Roca fina por deformación en falla',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Metamorfismo de impacto',
          content: `<p>Coesita y stishovita son fases de alta presión.</p>`,
          tip: 'Impactos liberan energía enorme.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre metamorfismo de impacto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Evidencia de impacto en cuarzo?',
              options: [
                'Líneas planares de choque',
                'Fósiles marinos',
                'Ripple marks',
                'Concreciones',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Porfiroblastos',
          content: `<p>Inclusiones en granate registran condiciones antiguas.</p>`,
          tip: 'Estaurolita forma cristales en forma de cruz.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre porfiroblastos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué son porfiroblastos?',
              options: [
                'Burbujas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mapas metamórficos',
          content: `<p>Contactos pueden ser graduales o abruptos.</p>`,
          tip: 'Mapas USGS muestran unidades por grado.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mapas metamórficos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Para qué sirve mapa metamórfico?',
              options: [
                'Localizar petróleo joven',
                'Medir radiación solar',
                'Interpretar historia tectónica',
                'Predecir clima diario',
              ],
              correct: 2,
            },
          ],
  ...
  },
  {
    ...
    description: 'Erosión, transporte y modelado del relieve',
    lessons: [
      {
        id: 'geo-l031',
        ...
        example: {
          title: 'Ejemplo: Meteorización física',
          content: `<p>Gelifracción abre grietas por hielo.</p>`,
          tip: 'Color oscuro acelera termoclastia.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre meteorización física.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué es gelifracción?',
              options: [
                'Disolución de calcita',
                'Depósito fluvial',
                'Fusión parcial',
                'Fractura por hielo en grietas',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Meteorización química',
          content: `<p>Feldespato→caolinita en climas húmedos.</p>`,
          tip: 'Lluvia ácida acelera disolución de caliza.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre meteorización química.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Clima de meteorización química intensa?',
              options: [
                'Tundra congelada',
                'Interior árido',
                'Tropical húmedo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Erosión fluvial',
          content: `<p>Meandros migran erosionando concavos.</p>`,
          tip: 'Curvas juntas indican valle encajado.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre erosión fluvial.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué forma un meandro?',
              options: [
                'Intrusión',
                'Erosión lateral en tramos bajos',
                'Solo glaciares',
                'Impacto',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Erosión glaciar',
          content: `<p>Circo evoluciona a lago glaciar.</p>`,
          tip: 'Estrías indican dirección de flujo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre erosión glaciar.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Perfil de valle glaciar?',
              options: [
                'U amplio',
                'V estrecho',
                'Delta plano',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Erosión eólica',
          content: `<p>Dunas barchan son media luna con viento constante.</p>`,
          tip: 'Deflación baja superficie hasta lecho rocoso.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre erosión eólica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Forma de duna barchan?',
              options: [
                'Línea recta',
                'Cono volcánico',
                'Media luna',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Procesos gravitacionales',
          content: `<p>Alud requiere pendiente, nieve inestable y disparador.</p>`,
          tip: 'Arcillas hidratadas deslizan lentamente.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre procesos gravitacionales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Talud de escoria?',
              options: [
                'Lava',
                'Acumulación al pie de pendiente',
                'Delta fluvial',
                'Arrecife',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Karst',
          content: `<p>Estalactitas del techo; estalagmitas del suelo.</p>`,
          tip: 'CO₂ del suelo acidifica agua subterránea.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre karst.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Crece del techo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Costas',
          content: `<p>Longshore drift transporta arena paralela a costa.</p>`,
          tip: 'Rocas resistentes forman cabos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre costas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Longshore drift?',
              options: [
                'Transporte paralelo de arena',
                'Subducción',
                'Metamorfismo',
                'Erupción submarina',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Suelos y horizontes',
          content: `<p>Horizonte B acumula arcilla lixiviada.</p>`,
          tip: 'Lateritas indican intemperismo tropical.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre suelos y horizontes.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Horizonte con orgánica?',
              options: [
                'Turbidita',
                'Horizonte A',
                'Horizonte C rocoso',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ciclo geológico',
          content: `<p>Cualquier roca puede transformarse con tiempo.</p>`,
          tip: 'Escala humana hace el ciclo aparentemente lento.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ciclo geológico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Destino de sedimento litificado?',
              options: [
                'Gas instantáneo',
                'Evaporación total',
                'Metamorfismo o subducción',
                'Permanencia sin cambio',
              ],
              correct: 2,
            },
          ],
  ...
  {
    id: 'geo-mod-5',
    title: 'Geología de campo',
    description: 'Técnicas de excursión, muestreo y seguridad',
    lessons: [
      {
        id: 'geo-l041',
        ...
        example: {
          title: 'Ejemplo: Equipo básico',
          content: `<p>Brújula de inclinación mide rumbo y buzamiento.</p>`,
          tip: 'Casco bajo paredes inestables.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre equipo básico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mide buzamiento?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mapas geológicos',
          content: `<p>Dientes en contacto indican roca más joven encima.</p>`,
          tip: 'Consulta siempre la leyenda.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mapas geológicos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Líneas de contacto?',
              options: [
                'Curvas de nivel solas',
                'Fronteras políticas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Strike y dip',
          content: `<p>Tres puntos definen un plano.</p>`,
          tip: 'Strike es perpendicular al buzamiento máximo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre strike y dip.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Strike perpendicular a?',
              options: [
                'Norte siempre',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Seguridad en afloramientos',
          content: `<p>Víboras en grietas soleadas en zonas áridas.</p>`,
          tip: 'No golpees sin revisar estabilidad.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre seguridad en afloramientos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Precaución en acantilado?',
              options: [
                'Casco y distancia de pared',
                'Martillo sin aviso',
                'Ignorar tormenta',
                'Trabajar solo sin avisar',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Muestreo ético',
          content: `<p>Algunos países regulan exportación de fósiles.</p>`,
          tip: 'Fotografía puede sustituir colección.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre muestreo ético.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Fósil en parque protegido?',
              options: [
                'Vender online',
                'Ocultar para saqueo',
                'Documentar sin extraer',
                'Excavar con pala',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Cuaderno de campo',
          content: `<p>Un croquis orientado vale más que texto sin mapa.</p>`,
          tip: 'Copia digital al final del día.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre cuaderno de campo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Esencial en croquis?',
              options: [
                'Publicidad',
                'Escala y norte',
                'Solo colores',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fallas',
          content: `<p>Normales en extensión; inversas en compresión.</p>`,
          tip: 'Zona de falla es débil a erosión.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fallas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Falla normal indica?',
              options: [
                'Compresión extrema',
                'Solo eólica',
                'Depósito glaciar',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fósiles in situ',
          content: `<p>Fósil sin contexto pierde información.</p>`,
          tip: 'Molde y contramolde van etiquetados juntos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fósiles in situ.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Por qué documentar posición?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Georreferenciación',
          content: `<p>5 m de error confunde contactos estrechos.</p>`,
          tip: 'Waypoints coinciden con etiquetas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre georreferenciación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Sistema común?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Informe post-excursión',
          content: `<p>Informe claro permite comparar años.</p>`,
          tip: 'Plantea hipótesis alternativas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre informe post-excursión.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Cierra informe sólido?',
              options: [
                'Opinión sin datos',
                'Sin coordenadas',
