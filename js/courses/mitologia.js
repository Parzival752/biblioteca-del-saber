export const CURRICULUM = [
  {
    id: 'mit-mod-1',
    title: 'Qué es un mito',
    description: 'Función cultural, no verdad literal',
    lessons: [
      {
        id: 'mit-l001',
        ...
        example: {
          title: 'Ejemplo: Definición académica',
          content: `<p>Mitología griega explica cosmos para helénos.</p>`,
          tip: 'Estudiar como literatura e historia ideas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre definición académica.',
          ...
          questions: [
            {
              ...
              options: [
                ...
                'Manual técnico',
                'Tabla periódica',
                'Relato cultural con funciones simbólicas',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Funciones del mito',
          content: `<p>Cosmogonía ordena caos.</p>`,
          tip: 'No competir con ciencia moderna.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre funciones del mito.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Función cosmogonía?',
              options: [
                'Predecir eclipse Newton',
                'Código Python',
                'Explicar origen mundo ordenado',
                'Medir gravedad',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mito vs religión',
          content: `<p>Religión incluye ritual vivo.</p>`,
          tip: 'Mito puede estudiarse secularmente.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mito vs religión.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estudio secular mitos?',
              options: [
                'Solo fe literal',
                'Análisis cultural e histórico',
                'Proselitismo obligatorio',
                'Negar existencia culturas',
              ],
              correct: 1,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Transmisión oral',
          content: `<p>Homero oral compuesto.</p>`,
          tip: 'No una versión \'correcta\' única.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre transmisión oral.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Versiones mito?',
              options: [
                'Múltiples según época y región',
                'Una sola oficial siempre',
                'Sin cambios nunca',
                'Solo Netflix',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Euhemerismo',
          content: `<p>Teoría antigua, no consenso actual.</p>`,
          tip: 'Útil como lente histórica.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre euhemerismo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Euhemerismo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Monomito Campbell',
          content: `<p>Modelo descriptivo no prescriptivo.</p>`,
          tip: 'Críticas simplifican diversidad.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre monomito campbell.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Monomito?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Animismo y totem',
          content: `<p>Respeto ecológico en algunos.</p>`,
          tip: 'Evitar estereotipo homogéneo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre animismo y totem.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Totem?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Pantheon estructura',
          content: `<p>Rey dioses espejo política.</p>`,
          tip: 'Comparar panteones.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre pantheon estructura.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Zeus similar a?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mito creation ex nihilo',
          content: `<p>Comparación estructural.</p>`,
          tip: 'Contexto histórico Babilonia.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mito creation ex nihilo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Enuma Elish?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Etica lectura',
          content: `<p>No costumes sagrados como disfraz.</p>`,
          tip: 'Consultar voces originarias.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre etica lectura.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estudiar mitos sagrados ajenos?',
              options: [
                'Afirmar literal como ciencia',
                'Ridiculizar creyentes',
                'Respeto y contexto académico',
                'Caricatura',
              ],
              correct: 2,
            },
  ...
  },
  {
    ...
    description: 'Grecia y Roma comparados',
    lessons: [
      {
        id: 'mit-l011',
        ...
        example: {
          title: 'Ejemplo: Teogonía Hesiodo',
          content: `<p>Cronos traga hijos mito tiempo.</p>`,
          tip: 'Zeus establece orden.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre teogonía hesiodo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Quién derrota a Cronos?',
              options: [
                'Hércules solo',
                'Odiseo',
                'Aquiles bebé',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Olimpo griego',
          content: `<p>Atenea sabiduría y guerra estratégica.</p>`,
          tip: 'Dioniso renovación.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre olimpo griego.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Diosa sabiduría griega?',
              options: [
                'Hades sol',
                'Poseidón fuego',
                'Atenea',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Héroes griegos',
          content: `<p>Nostoi regresos.</p>`,
          tip: 'Catálogo barcos Ilíada.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre héroes griegos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Odisea trata?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Romanización mitos',
          content: `<p>Pietas romana vs arete.</p>`,
          tip: 'Eneida fundación Roma.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre romanización mitos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Eneida Virgilio?',
              options: [
                'Mito origen romano Eneas',
                'Manual agrícola',
                'Tratado física',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mitología romana práctica',
          content: `<p>Religión cívica.</p>`,
          tip: 'No solo copia griega.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mitología romana práctica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Augur romano?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Troya arqueológica',
          content: `<p>Guerra Troya mezcla historia leyenda.</p>`,
          tip: 'Ciudad real excavada.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre troya arqueológica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Troya?',
              options: [
                'Ficción sin base',
                'Yacimiento real + capa mítica literaria',
                'Solo invento',
                'Planeta',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tragedia y mito',
          content: `<p>Destino vs responsabilidad.</p>`,
          tip: 'Teatro Atenas festival.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tragedia y mito.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Edipo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mitos naturaleza',
          content: `<p>No explicación botánica.</p>`,
          tip: 'Rito Eleusis.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mitos naturaleza.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Rapto Perséfone simboliza?',
              options: [
                'Estaciones/ciclo vegetal cultural',
                'Gravedad',
                'Fotosíntesis detalle',
                'Placas tectónicas',
              ],
              correct: 0,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Iconografía',
          content: `<p>Cuervo Atenea.</p>`,
          tip: 'Arte clásico transmite mito.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre iconografía.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Tridente?',
              options: [
                'Hades tridente siempre',
                'Poseidón/Neptuno',
                'Apolo',
                'Hermes',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Recepción moderna',
          content: `<p>Adaptación creativa.</p>`,
          tip: 'Crítica fidelidad.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre recepción moderna.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Clash Titans vs mito?',
              options: [
                'Paper peer review',
                'Informe bursátil',
                'Adaptación popular moderna',
                'Texto arcaico literal',
              ],
              correct: 2,
            },
          ],
  ...
  {
    id: 'mit-mod-3',
    title: 'Tradiciones comparadas',
    description: 'Norte Europa, Mesoamérica y África',
    lessons: [
      {
        id: 'mit-l021',
        ...
        example: {
          title: 'Ejemplo: Nórdico cosmología',
          content: `<p>Ragnarok ciclo fin renovación.</p>`,
          tip: 'Odín sacrificio conocimiento.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nórdico cosmología.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Yggdrasil?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mesoamérica Quetzalcoatl',
          content: `<p>No monolito.</p>`,
          tip: 'Conquista reinterpretaciones.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mesoamérica quetzalcoatl.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Quetzalcoatl?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Popol Vuh',
          content: `<p>Maíz humanidad.</p>`,
          tip: 'Texto colonial recopilado.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre popol vuh.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Popol Vuh?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Yoruba Orishas',
          content: `<p>Sincretismo Américas.</p>`,
          tip: 'Respeto tradición viva.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre yoruba orishas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Orisha Eshu?',
              options: [
                'Trickster/mensajero yoruba',
                'Dios griego Zeus',
                'Santo católico mismo',
                'Planeta',
              ],
              correct: 0,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Anansi',
          content: `<p>Oralidad caribe.</p>`,
          tip: 'Enseñanza astucia.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre anansi.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Anansi?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Dreamtime aborigen',
          content: `<p>Conexión tierra.</p>`,
          tip: 'No folclore genérico.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre dreamtime aborigen.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dreamtime?',
              options: [
                'App móvil',
                'Marco cosmológico aborigen australiano',
                'Videojuego',
                'Teoría cuerdas',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Comparación diluvio',
          content: `<p>Motivo común no implica contacto.</p>`,
          tip: 'Función advertencia.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre comparación diluvio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mito diluvio común?',
              options: [
                'Prueba geología única',
                'Evento idéntico probado',
                'Invención moderna',
                'Motivo narrativo recurrente',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Trickster global',
          content: `<p>Rompe reglas enseña límites.</p>`,
          tip: 'Ambivalente.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre trickster global.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Trickster?',
              options: [
                'Figura ambigua desafía orden',
                'Villano puro',
                'Héroe sin fallas',
                'Científico',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Heroína en mitos',
          content: `<p>Sesgo fuentes patriarcales.</p>`,
          tip: 'Relectura crítica.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre heroína en mitos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Amaterasu?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sincretismo',
          content: `<p>Colonialismo impacta.</p>`,
          tip: 'Estudio histórico.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sincretismo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Sincretismo?',
  ...
  },
  {
    ...
    description: 'Estructuralismo, arquetipos y contexto',
    lessons: [
      {
        id: 'mit-l031',
        ...
        example: {
          title: 'Ejemplo: Lévi-Strauss estructural',
          content: `<p>Estructura mente humana debate.</p>`,
          tip: 'No verdad universal aceptada.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre lévi-strauss estructural.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estructuralismo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Jung arquetipos',
          content: `<p>Psicología no mitología histórica.</p>`,
          tip: 'Metáfora útil crítica.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre jung arquetipos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Arquetipo Jung?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Contexto histórico',
          content: `<p>Evitar presentismo.</p>`,
          tip: 'Fuentes datadas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre contexto histórico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Contextualizar?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Análisis simbólico',
          content: `<p>No diccionario fijo.</p>`,
          tip: 'Cultura específica manda.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre análisis simbólico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Serpiente siempre mal?',
              options: [
                'Depende cultura y mito',
                'Siempre diabólica',
                'Siempre wifi',
                'Siempre Python',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Comparativa responsable',
          content: `<p>Diffusion vs poligenesis.</p>`,
          tip: 'Evitar universalizar.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre comparativa responsable.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Comparar mitos?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fuentes primarias',
          content: `<p>Wikipedia punto partida no fin.</p>`,
          tip: 'Notas críticas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fuentes primarias.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Fuente primaria?',
              options: [
                'Chat GPT sin verificar',
                'Texto antiguo original traducido',
                'Meme Instagram',
                'Película sola',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Arqueología mito',
          content: `<p>Material complementa texto.</p>`,
          tip: 'No prueba evento literal.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre arqueología mito.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Vaso pintado?',
              options: [
                ...
                'Video CCTV antiguo',
                'Selfie Zeus',
                'Evidencia iconográfica cultural',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mitología contemporánea',
          content: `<p>Cultura pop estudiable.</p>`,
          tip: 'No reemplaza clásicos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mitología contemporánea.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Superhéroe mito moderno?',
              options: [
                'Narrativa cultural actual',
                'Documento legal',
                'Teorema',
                'Manual cocina',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Escritura comparativa ensayo',
          content: `<p>Argumento, no lista.</p>`,
          tip: 'Contraargumento.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre escritura comparativa ensayo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Ensayo mitología?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Presentación oral',
          content: `<p>Claridad audiencia.</p>`,
          tip: 'Q&A preparado.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre presentación oral.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Presentar mito?',
  ...
  },
  {
    ...
    description: 'Proyectos prácticos comparativos',
    lessons: [
      {
        id: 'mit-l041',
        ...
        example: {
          title: 'Ejemplo: Elegir par mitos',
          content: `<p>Acceso fuentes español.</p>`,
          tip: 'Profundidad > amplitud.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre elegir par mitos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Proyecto comparativo?',
              options: [
                'Diez sin leer',
                'Sin tema',
                'Aleatorio',
                'Dos mitos tema común',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mapa conceptual',
          content: `<p>Colores por cultura.</p>`,
          tip: 'Leyenda clara.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mapa conceptual.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mapa mito?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tabla comparativa',
          content: `<p>Citas breves.</p>`,
          tip: 'Bibliografía columna.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tabla comparativa.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Tabla?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Línea temporal',
          content: `<p>No confundir fecha mito vs composición.</p>`,
          tip: 'Contexto BCE/CE.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre línea temporal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Ilíada compuesta?',
              options: [
                'Arcaico griego siglos VIII-VII a.C. aprox',
                '2024 d.C.',
                'Era Jurásica',
                'Big Bang',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Glosario personal',
          content: `<p>Repaso examen.</p>`,
          tip: 'Ejemplo por término.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre glosario personal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Hubris?',
              options: [
                'Tipo roca',
                'Comando Linux',
                'Exceso orgullo castigado en tragedia',
                'Virtud',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Resumen académico',
          content: `<p>Cita autor.</p>`,
          tip: 'Párrafo único prohibido.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre resumen académico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Resumen académico?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Debate en clase',
          content: `<p>Escuchar postura opuesta.</p>`,
          tip: 'Moderador tiempo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre debate en clase.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Debate mitología?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Arte y mito',
          content: `<p>Postura, atributos, periodo.</p>`,
          tip: 'Comparar dos obras.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre arte y mito.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Iconografía?',
              options: [
                'Estudio símbolos visuales',
                'Opinión gustos',
                'Precio subasta',
                'Selfie',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mito local',
          content: `<p>Archivo municipal.</p>`,
          tip: 'Distinción leyenda/mito.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mito local.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Leyenda local?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Portfolio final',
          content: `<p>Reflexión qué aprendiste método.</p>`,
          tip: 'Autoevaluación rubrica.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre portfolio final.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Portfolio mitología?',
              options: [
                'Vacío',
                'Plagio wiki',
                'Conjunto evidencias aprendizaje',
                'Solo meme',
              ],
              correct: 2,
            },
