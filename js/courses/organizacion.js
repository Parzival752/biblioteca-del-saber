export const CURRICULUM = [
  {
    id: 'org-mod-1',
    title: 'Externalización y captura',
    description: 'Sacar tareas de la cabeza a sistema confiable',
    lessons: [
      {
        id: 'org-l001',
        ...
        example: {
          title: 'Ejemplo: Inbox universal',
          content: `<p>Mente libre para foco, no recordar listas.</p>`,
          tip: 'Procesar inbox diario 10 min.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre inbox universal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Para qué inbox?',
              options: [
                'Recordar todo mental',
                '50 apps inbox',
                'Ignorar capturas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Brain dump',
          content: `<p>Después clasificar, no durante dump.</p>`,
          tip: 'Semanal en domingo útil.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre brain dump.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Brain dump?',
              options: [
                'Solo en cabeza',
                'Una vez al año',
                'Vaciar mente antes organizar',
                'Organizar mientras volcar',
              ],
              correct: 2,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Segundo cerebro ligero',
          content: `<p>No over-engineer PARA si no lo usarás.</p>`,
          tip: 'Busca > taxonomía perfecta.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre segundo cerebro ligero.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Segundo cerebro simple?',
              options: [
                'Post-its suelo',
                'Notas encontrables por proyecto',
                '1000 carpetas vacías',
                'Solo memoria',
              ],
              correct: 1,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Recordatorios contexto',
          content: `<p>Context beats time solo.</p>`,
          tip: 'No saturar notificaciones.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre recordatorios contexto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Recordatorio útil?',
              options: [
                'Ligado a contexto acción',
                '100 alarmas hora',
                'Silenciar todo',
                'Tatuaje',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Listas por contexto',
          content: `<p>Reduce cambio contexto.</p>`,
          tip: 'GTD popularizó contexts.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre listas por contexto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Agrupar llamadas?',
              options: [
                'Sin listas',
                'Solo urgente',
                'Lista @llamadas batch',
                'Una tarea random cada hora',
              ],
              correct: 2,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Plantillas checklist',
          content: `<p>Reduce olvidos sin fuerza de voluntad.</p>`,
          tip: 'Laminar reutilizable.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre plantillas checklist.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Checklist salida?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Calendario bloques',
          content: `<p>Si no está en calendario, no existe.</p>`,
          tip: 'Incluye buffers.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre calendario bloques.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Bloque estudio?',
              options: [
                'Estudiar cuando sobre',
                'Solo lista tareas',
                'Ignorar calendario',
                'Cita contigo mismo',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Referencias visibles',
          content: `<p>Out of sight out of mind real.</p>`,
          tip: 'Quitar cuando cumplido.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre referencias visibles.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Deadline importante?',
              options: [
                'Visible entorno estudio',
                'Solo en app enterrada',
                'Memorizar',
                'Ignorar',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Captura voz',
          content: `<p>Transcribir después en procesamiento.</p>`,
          tip: 'Útil cuando manos ocupadas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre captura voz.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Idea caminando?',
              options: [
                'Gritar',
                'Nota voz procesar luego',
                'Olvidar seguro',
                'Parar tráfico escribir',
              ],
              correct: 1,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Revisión semanal',
          content: `<p>Ancla del sistema.</p>`,
          tip: 'Ajusta lo que falló.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre revisión semanal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Revisión semanal?',
              options: [
                'Solo cuando crisis',
                'Diario 5h',
                'Recalibrar sistema organización',
                'Nunca revisar',
              ],
              correct: 2,
            },
  ...
  },
  {
    id: 'org-mod-2',
    title: 'Tiempo y foco',
    description: 'Timers, Pomodoro y transiciones',
    lessons: [
      {
        id: 'org-l011',
        ...
        example: {
          title: 'Ejemplo: Pomodoro 25/5',
          content: `<p>Descanso levantarse moverse.</p>`,
          tip: 'Ajusta 15/3 si 25 largo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre pomodoro 25/5.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Pomodoro clásico?',
              options: [
                '8 horas sin pausa',
                '1 min estudio',
                'Solo cronómetro infinito',
                '25 min trabajo 5 pausa',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Timeboxing',
          content: `<p>Done > perfect en caja.</p>`,
          tip: 'Alarma fin caja.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre timeboxing.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Timeboxing?',
              options: [
                'Sin límite',
                '0 minutos',
                'Límite tiempo por tarea',
                'Hasta perfecto infinito',
              ],
              correct: 2,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Timer visible',
          content: `<p>Presión suave visual.</p>`,
          tip: 'Evita mirar reloj teléfono distractor.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre timer visible.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Timer visible?',
      ...
      },
      {
        ...
        example: {
          ...
          content: `<p>Reduce inercia cambio tarea.</p>`,
          tip: 'Mismo ritual cada vez.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre transiciones.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Entre bloques estudio?',
              options: [
                'Ritual transición corto',
                'Saltar directo caos',
                '30 min Instagram',
                'Siesta 2h',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Single-tasking',
          content: `<p>Multitarea divide atención.</p>`,
          tip: 'Escritorio físico igual.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre single-tasking.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estudio efectivo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Parkinson adaptado',
          content: `<p>Deadline artificial productivo.</p>`,
          tip: 'Comunicar si grupo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre parkinson adaptado.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Tarea ocupa todo día?',
              options: [
                'Copiar',
                'Acortar deadline artificial',
                'Sin deadline meses',
                'Eliminar sueño',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Energy mapping',
          content: `<p>Mañana vs noche individual.</p>`,
          tip: 'Tareas admin en valle.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre energy mapping.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Matemáticas difícil?',
              options: [
                'Medianoche siempre',
                'Post comida pesada',
                'Con sueño',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Descansos movimiento',
          content: `<p>Movimiento regula arousal.</p>`,
          tip: 'No pantalla en pausa.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre descansos movimiento.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Pausa Pomodoro?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Anti-distraction environment',
          content: `<p>Extensión bloquea sitios estudio.</p>`,
          tip: 'Auriculares cancelación ruido.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre anti-distraction environment.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Sesión foco?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tracking tiempo opcional',
          content: `<p>Datos ajustan estimaciones.</p>`,
          tip: 'No micro-track forever.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tracking tiempo opcional.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Diagnóstico tiempo?',
              options: [
                'Nunca medir',
                'Adivinar',
                'Track corto periodo',
                'Track cada segundo forever',
              ],
              correct: 2,
            },
          ],
  ...
  {
    id: 'org-mod-3',
    title: 'Body doubling y accountability',
    description: 'Presencia ajena y compromisos externos',
    lessons: [
      {
        id: 'org-l021',
        ...
        example: {
          title: 'Ejemplo: Body doubling',
          content: `<p>No necesita ayuda activa.</p>`,
          tip: 'Biblioteca cuenta como doble.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre body doubling.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Body double?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Focusmate estilo',
          content: `<p>Compromiso social suave.</p>`,
          tip: 'Respetar reglas plataforma.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre focusmate estilo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Cowork virtual?',
              options: [
                'Sin check-in',
                'Jugar',
                'Compromiso temporal compartido',
                'Chat todo el tiempo',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Grupo estudio estructurado',
          content: `<p>Facilitador rota semanal.</p>`,
          tip: 'Evitar solo socializar.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre grupo estudio estructurado.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Grupo efectivo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Accountability partner',
          content: `<p>Mutuo no jerárquico.</p>`,
          tip: 'Amable en fallos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre accountability partner.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Partner accountability?',
              options: [
                'Check-in mutuo progreso',
                'Castigo dinero',
                'Competir tóxico',
                'Ghosting',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Contrato consigo mismo',
          content: `<p>Recompensa cumplimiento pequeña.</p>`,
          tip: 'No castigo duro.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre contrato consigo mismo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Compromiso escrito?',
              options: [
                'Amenaza extrema',
                'Sin meta',
                'Clarifica intención',
                'Solo verbal olvidado',
              ],
              correct: 2,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Clases grabadas ritmo',
          content: `<p>Pausa activa notas.</p>`,
          tip: 'No solo pasivo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre clases grabadas ritmo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Lecture larga?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Biblioteca como ancla',
          content: `<p>Ritual llegada: agua, timer, objetivo.</p>`,
          tip: 'Casa requiere más cues.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre biblioteca como ancla.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Mismo lugar estudiar?',
              options: [
                'Cama principal',
                'Sofá TV',
                'Random diario',
                'Señal contextual hábito',
              ],
              correct: 3,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Música foco',
          content: `<p>Letra compite lenguaje.</p>`,
          tip: 'Prueba binaural si funciona.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre música foco.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Música estudio?',
              options: [
                ...
                'Podcast',
                'Rock vocal',
                'Silencio absoluto siempre required',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Gamificación ligera',
          content: `<p>Recompensa proporcional.</p>`,
          tip: 'Evitar infantilizar si no motiva.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre gamificación ligera.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Racha visible?',
              options: [
                'Premio caro cada hora',
                'Motivación extrínseca suave',
                'Castigo físico',
                'Sin feedback',
              ],
              correct: 1,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Límites sociales estudio',
          content: `<p>FOMO normal; prioridad explícita.</p>`,
          tip: 'Recuperar social después.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre límites sociales estudio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Bloque sagrado?',
  ...
  {
    id: 'org-mod-4',
    title: 'Materiales y espacio',
    description: 'Minimizar fricción física y digital',
    lessons: [
      {
        id: 'org-l031',
        ...
        example: {
          title: 'Ejemplo: Mochila lista',
          content: `<p>Evita olvidar calculadora examen.</p>`,
          tip: 'Duplicar críticos baratos.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mochila lista.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Noche antes clase?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Escritorio clear',
          content: `<p>Visual clutter distrae.</p>`,
          tip: 'Reset fin sesión.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre escritorio clear.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Escritorio estudio?',
              options: [
                'Comida días',
                '30 monitores',
                'Mínimo visible sesión',
                'Papeles meses',
              ],
              correct: 2,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Digital desktop',
          content: `<p>Downloads zero weekly.</p>`,
          tip: 'Iconos menos = mejor.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre digital desktop.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Archivos activos?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Bookmarks estudio',
          content: `<p>Un click LMS.</p>`,
          tip: 'Sync navegador.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre bookmarks estudio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Recursos frecuentes?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Impresión batch',
          content: `<p>Evita 'necesito imprimir' bloqueo.</p>`,
          tip: 'Doble si barato.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre impresión batch.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Readings semana?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Suministros backup',
          content: `<p>Frustración supply = abandono.</p>`,
          tip: 'Lista restock mensual.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre suministros backup.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dos bolígrafos?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Iluminación',
          content: `<p>Evita solo luz techo espalda.</p>`,
          tip: 'Luz natural lateral ideal.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre iluminación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estudiar noche?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ruido control',
          content: `<p>White noise app tren.</p>`,
          tip: 'Comunicar familia horario.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ruido control.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Ruido vecinos?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Digital minimal tabs',
          content: `<p>RAM y atención.</p>`,
          tip: 'Cerrar post sesión.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre digital minimal tabs.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Demasiadas pestañas?',
              options: [
                'Incognito 20',
                'Limitar activas',
                'Abrir más',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Reset espacio post',
          content: `<p>Mañana empieza limpio.</p>`,
          tip: 'Hábito ancla.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre reset espacio post.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Fin estudio?',
  ...
  {
    id: 'org-mod-5',
    title: 'Estudio activo y repaso',
    description: 'Técnicas que reducen procrastinación de inicio',
    lessons: [
      {
        id: 'org-l041',
        ...
        example: {
          title: 'Ejemplo: Regla 2 minutos',
          content: `<p>Inicio reduce activación.</p>`,
          tip: 'A menudo continúas.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre regla 2 minutos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Procrastinación?',
              options: [
                'Esperar motivación perfecta',
                'Multitarea',
                'Cancelar día',
                'Empezar 2 minutos',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Active recall',
          content: `<p>Reconocimiento ≠ recuerdo.</p>`,
          tip: 'Espaciado repetición.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre active recall.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Estudiar activo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Feynman técnica',
          content: `<p>Detecta huecos comprensión.</p>`,
          tip: 'Sin jerga.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre feynman técnica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Feynman?',
              options: [
                'Ignorar dudas',
                'Explicar simple detecta lagunas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Interleaving',
          content: `<p>Mejor transferencia examen.</p>`,
          tip: 'Más difícil pero eficaz.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre interleaving.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Practicar examen?',
              options: [
                'Mezclar tipos problemas',
                'Solo un tipo horas',
                'Solo leer',
                'Sin practicar',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Chunking materia',
          content: `<p>Mapa mental una página.</p>`,
          tip: 'Priorizar core concepts.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre chunking materia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Capítulo largo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Spaced repetition',
          content: `<p>Olvido curva Ebbinghaus.</p>`,
          tip: 'Consistencia > cram.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre spaced repetition.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Memoria largo plazo?',
              options: [
                'No repasar',
                'Repaso espaciado',
                'Cram noche antes solo',
                'Leer una vez',
              ],
              correct: 1,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Practice exams',
          content: `<p>Reduce ansiedad sorpresa.</p>`,
          tip: 'Revisar errores categoría.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre practice exams.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Preparación examen?',
              options: [
                'Solo resumen',
                'Copiar respuestas',
                'Ignorar formato',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Reward pairing',
          content: `<p>Dopamina refuerzo.</p>`,
          tip: 'No solo recompensa final lejana.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre reward pairing.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Tras bloque?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sleep hygiene estudio',
          content: `<p>Repaso breve antes dormir ok.</p>`,
          tip: 'No sustituye sueño.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sleep hygiene estudio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿All-nighter?',
              options: [
                'Requerido',
                'Perjudica memoria y foco',
                'Siempre ideal',
                'Mejor que estudiar día',
              ],
              correct: 1,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Autoevaluación honesta',
          content: `<p>Ajuste sistema personal.</p>`,
          tip: 'No culpa, experimento.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre autoevaluación honesta.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Cierre semanal estudio?',
              options: [
                'Copiar sistema ajeno ciego',
                'Rendirse',
                'Reflexionar y ajustar hábitos',
                'Ignorar resultados',
              ],
              correct: 2,
            },
