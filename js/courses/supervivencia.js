export const CURRICULUM = [
  {
    id: 'sup-mod-1',
    title: 'Refugio y abrigo',
    description: 'Protección contra clima y pérdida de calor',
    lessons: [
      {
        id: 'sup-l001',
        ...
        example: {
          title: 'Ejemplo: Prioridades de supervivencia',
          content: `<p>Hipothermia mata en horas; deshidratación en días; hambre tarda más.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar prioridades de supervivencia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre prioridades de supervivencia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'En frío húmedo prioriza…',
              options: [
                'Refugio y calor',
                'Comida primero',
                'Selfies',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Refugio de emergencia',
          content: `<p>Rama inclinada con ramas y hojas en 30 minutos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar refugio de emergencia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre refugio de emergencia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Refugio debe…',
              options: [
                'Aislar del suelo y viento',
                'Ser abierto al viento',
                'Sin techo',
                'Solo decorativo',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Lean-to y A-frame',
          content: `<p>Lean-to con viento a espaldas del refugio.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar lean-to y a-frame en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre lean-to y a-frame.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Lean-to se apoya en…',
              options: [
                'Tronco o línea',
                'Solo una piedra',
                'Agua',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Aislamiento del suelo',
          content: `<p>30 cm de hojas secas bajo sleeping pad improvisado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar aislamiento del suelo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre aislamiento del suelo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Suelo frío quita calor por…',
              options: [
                'Conducción',
                'Fotosíntesis',
                'Magnetismo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Refugio de nieve',
          content: `<p>Quinzee: pila de nieve hueca con ventilación superior.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar refugio de nieve en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre refugio de nieve.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Refugio nieve necesita…',
              options: [
                'Ventilación',
                'Entrada sellada hermética',
                'Fuego dentro',
                'Agua líquida',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Refugio en desierto',
          content: `<p>Lona o manta sobre ramas a 40 cm del suelo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar refugio en desierto en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre refugio en desierto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'En desierto evita…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Hamaca y tienda',
          content: `<p>Estaca a 45° con línea tensada alejada del poste.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar hamaca y tienda en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre hamaca y tienda.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Doble techo evita…',
              options: [
                'Condensación en interior',
                'Viento siempre',
                'Frío siempre',
                'Insectos',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ubicación del campamento',
          content: `<p>Campo alto con drenaje lejos de deadfall.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar ubicación del campamento en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ubicación del campamento.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Evita dormir en…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Materiales naturales',
          content: `<p>Abeto proporciona ramas densas; hojas de roble en otoño.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar materiales naturales en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre materiales naturales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Material aislante ideal…',
              options: [
                'Seco y voluminoso',
                'Mojado',
                'Metálico frío',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Refugio grupal',
          content: `<p>Refugio A-frame grande para 4 personas rota turnos de leña.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar refugio grupal en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre refugio grupal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Grupo en supervivencia…',
              options: [
                'Comparte calor y tareas',
                'Dispersarse solos',
                'Sin comunicación',
                'Sin plan',
              ],
  ...
  {
    id: 'sup-mod-2',
    title: 'Agua en supervivencia',
    description: 'Hallazgo, potabilización y conservación de agua',
    lessons: [
      {
        id: 'sup-l011',
        ...
        example: {
          title: 'Ejemplo: Regla de los 3',
          content: `<p>En calor desierto la deshidratación acelera.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar regla de los 3 en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre regla de los 3.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Sin agua sobrevives aprox…',
              options: [
                '3 días',
                '3 horas',
                '3 meses',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fuentes de agua',
          content: `<p>Seguir valle bajo y huellas animales hacia agua.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar fuentes de agua en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fuentes de agua.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Señal de agua cercana…',
              options: [
                'Vegetación verde en valle',
                'Cima seca',
                'Arena sin vida',
                'Roca sola',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Recolección de lluvia',
          content: `<p>Paracaídas o poncho en hoyo recolecta litros en tormenta.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar recolección de lluvia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre recolección de lluvia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Recolectar lluvia requiere…',
              options: [
                'Superficie limpia',
                'Solo tierra',
                'Fuego',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Filtración mecánica',
          content: `<p>Botella cortada con algodón, arena y carbón de fogata.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar filtración mecánica en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre filtración mecánica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Filtro mecánico quita…',
              options: [
                'Partículas',
                'Virus todos',
                'Químicos todos',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Purificación por hervido',
          content: `<p>A 2000 m hierve 3 minutos por menor punto de ebullición.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar purificación por hervido en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre purificación por hervido.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Hervir mata…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tabletas y filtros comerciales',
          content: `<p>Potabilizador en botella Squeeze para senderismo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar tabletas y filtros comerciales en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tabletas y filtros comerciales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Yodo/cloro tablets…',
              options: [
                'Desactivan patógenos',
                'Quitan sal',
                'Filtran plomo',
                'Cocinan comida',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Agua de vegetación',
          content: `<p>Rama hoja en bolsa plástica al sol gotea agua limpia.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar agua de vegetación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre agua de vegetación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Bolsa solar en rama…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Hielo y nieve',
          content: `<p>Derretir nieve en botella junto al cuerpo antes de hervir.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar hielo y nieve en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre hielo y nieve.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Comer nieve directo…',
              options: [
                'Enfría cuerpo',
                'Hidrata eficiente',
                'Calienta',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Contaminantes químicos',
          content: `<p>Agua cerca de mina requiere evitar o equipo especializado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar contaminantes químicos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre contaminantes químicos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Hervir NO elimina…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Hidratación y electrolitos',
          content: `<p>Pinch de sal y limón en agua tras día caluroso intenso.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar hidratación y electrolitos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre hidratación y electrolitos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Electrolitos importantes porque…',
              options: [
                'Nervios y músculos los necesitan',
                'Solo sabor',
                'Solo color',
                'No importan',
              ],
  ...
  },
  {
    id: 'sup-mod-3',
    title: 'Fuego',
    description: 'Ignición, combustibles y gestión segura del fuego',
    lessons: [
      {
        id: 'sup-l021',
        ...
        example: {
          title: 'Ejemplo: Importancia del fuego',
          content: `<p>Fuego nocturno disuade animales curiosos y orienta rescate.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar importancia del fuego en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre importancia del fuego.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Fuego permite…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Triángulo del fuego',
          content: `<p>Apagar cubriendo brasas priva oxígeno.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar triángulo del fuego en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre triángulo del fuego.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Triángulo del fuego…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Preparación de leña',
          content: `<p>Corteza de abedul, fatwood o vellos secos como yesca.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar preparación de leña en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre preparación de leña.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Yesca es…',
              options: [
                'Material que prende fácil',
                'Tronco grueso',
                'Piedra',
                'Metal',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fricción arco y taladro',
          content: `<p>Arco en board de cedro seco con notch en base.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar fricción arco y taladro en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fricción arco y taladro.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Fricción necesita…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Pedernal y ferrocerio',
          content: `<p>Raspado de ferrocerio en cotton vaselinado enciende rápido.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar pedernal y ferrocerio en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre pedernal y ferrocerio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Lupa solar',
          content: `<p>Lupa reloj quema punto en carbón o hongo sec.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar lupa solar en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre lupa solar.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Lupa solar necesita…',
              options: [
                'Sol directo y yesca seca',
                'Noche',
                'Lluvia',
                'Nieve',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tipos de fogata',
          content: `<p>Teepee central para encender; luego log cabin.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar tipos de fogata en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tipos de fogata.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Teepee sirve para…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fuego en humedad',
          content: `<p>Partir tronco muerto: interior seco aunque exterior mojado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar fuego en humedad en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fuego en humedad.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Dead standing seco…',
              options: [
                'Interior del tronco',
                'Exterior mojado',
                'Hojas verdes',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Seguridad y extinción',
          content: `<p>Brasas frías al tacto antes de dejar campamento.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar seguridad y extinción en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre seguridad y extinción.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Apagar fogata…',
              options: [
                'Agua y revolver tierra',
                'Solo tapar hojas',
                'Dejar brasas',
                'Echar gasolina',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Fuego como señal',
          content: `<p>Tres humos o tres fogatas en triángulo señal SOS clásica.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar fuego como señal en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre fuego como señal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Humo denso se logra con…',
              options: [
                'Material verde/húmedo controlado',
                'Solo gasolina',
                'Plástico tóxico sin control',
                'Agua',
              ],
              correct: 0,
            },
  ...
  },
  {
    ...
    description: 'Nudos esenciales para campamento y rescate',
    lessons: [
      {
        id: 'sup-l031',
        ...
        example: {
          title: 'Ejemplo: Material de cuerda',
          content: `<p>Paracord en brida y línea de tienda; sisal quema como yesca.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar material de cuerda en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre material de cuerda.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Paracord 550 soporta…',
              options: [
                '~550 libras',
                '5 libras',
                '5000 libras',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo as de guía',
          content: `<p>Rescate: as de guía en pecho con cuerda sobre hombros.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo as de guía en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo as de guía.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'As de guía…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo de rizo',
          content: `<p>Extender línea de tienda con rizo doble bien apretado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo de rizo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo de rizo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Rizo une…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo de bolina',
          content: `<p>Amarrar bolina en poste de tienda.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo de bolina en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo de bolina.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Bolina forma…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo de trinca',
          content: `<p>Trinca en estaca de tienda con tensión hacia afuera.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo de trinca en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo de trinca.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Trinca sirve para…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo de pescador',
          content: `<p>Unir paracord delgado a grueso en tráiler de mochila.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo de pescador en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo de pescador.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Pescador une…',
              options: [
                'Cuerdas distinto grosor',
                'Solo postes',
                'Solo anillas',
                'Solo cadenas',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo de rizo doble',
          content: `<p>Línea principal de hamaca con rizo doble mojado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo de rizo doble en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo de rizo doble.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Rizo doble es…',
              options: [
                'Más seguro que simple',
                'Menos seguro',
                'Solo decorativo',
                'Imposible deshacer',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Línea de vida y anclaje',
          content: `<p>Anilla en árbol con cinturón y trinca triangulada.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar línea de vida y anclaje en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre línea de vida y anclaje.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Anclaje múltiple…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nudo corredizo y precaución',
          content: `<p>Corredizo ajusta línea de tienda pero revisar apriete.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nudo corredizo y precaución en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nudo corredizo y precaución.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Corredizo en rescate…',
              options: [
                'Usar con precaución',
                'Siempre ideal',
                'Prohibido siempre',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mantenimiento de cuerda',
          content: `<p>Cuerda mojada secada a sombra; cortar extremos deshilachados.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mantenimiento de cuerda en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mantenimiento de cuerda.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Cuerda mojada debe…',
              options: [
                'Secarse antes de guardar',
                'Guardarse húmeda enrollada',
                'Quemarse siempre',
                'Congelarse',
              ],
              correct: 0,
  ...
  {
    id: 'sup-mod-5',
    title: 'Orientación y kits',
    description: 'Navegación básica y equipamiento de supervivencia',
    lessons: [
      {
        id: 'sup-l041',
        ...
        example: {
          title: 'Ejemplo: Brújula básica',
          content: `<p>Brújula baseplate con espejo para apuntar objetivo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar brújula básica en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre brújula básica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Aguja brújula apunta…',
              options: [
                'Norte magnético',
                'Sur geográfico siempre',
                'Este siempre',
                'Oeste siempre',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Orientación sin brújula',
          content: `<p>Palo vertical: punta sombra más corta al mediodía sur (hemisferio norte).</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar orientación sin brújula en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre orientación sin brújula.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'En hemisferio norte mediodía sombra apunta…',
              options: [
                'Aproximadamente norte',
                'Sur',
                'Este',
                'Oeste',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mapa y terreno',
          content: `<p>Líneas juntas = pendiente fuerte; V apuntando arriba = valle.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mapa y terreno en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mapa y terreno.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Curvas muy juntas indican…',
              options: [
                'Pendiente fuerte',
                'Terreno plano',
                'Agua profunda',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Señales de rescate',
          content: `<p>Espejo heliógrafo en avión: flashes en serie de tres.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar señales de rescate en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre señales de rescate.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'SOS en tierra puede ser…',
              options: [
                'Tres señales repetidas',
                'Una señal',
                'Silencio',
                'Nada',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Kit de supervivencia básico',
          content: `<p>Altoids tin: ferrocerio, yesca, silbato, cinta, hilo, pastillas agua.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar kit de supervivencia básico en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre kit de supervivencia básico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Planificación de salida',
          content: `<p>Nota en papel: ruta, vehículo, contacto emergencia.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar planificación de salida en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre planificación de salida.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Antes de salir informa…',
              options: [
                'Ruta y hora retorno',
                'Solo redes sociales',
                'Nadie',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Riesgo de hipotermia',
          content: `<p>Detener, refugio, capas secas, bebida caliente si consciente.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar riesgo de hipotermia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre riesgo de hipotermia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Hipotermia empeora con…',
              options: [
                'Mojado y viento',
                'Abrigo seco',
                'Refugio',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Calor e hipertermia',
          content: `<p>Sombra, enfriar cuello/axilas, agua lentamente, evacuar.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar calor e hipertermia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre calor e hipertermia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Golpe de calor requiere…',
              options: [
                'Enfriamiento y agua',
                'Más ejercicio',
                'Alcohol',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Comida en supervivencia',
          content: `<p>Nunca comer seta o planta no identificada al 100%.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar comida en supervivencia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre comida en supervivencia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Comida en supervivencia…',
              options: [
                'Prioridad tras agua/refugio',
                'Primera prioridad siempre',
                'Ignorar identificación',
                'Solo bayas rojas',
              ],
              correct: 0,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mentalidad y S.T.O.P.',
          content: `<p>Perdido: sentarse, respirar, evaluar recursos y trazar plan.</p>`,
          ...
          questions: [
            {
              q: 'S.T.O.P. significa…',
              options: [
                'Sentarse, pensar, observar, planear',
                'Correr rápido',
                'Gritar solo',
                'Dormir inmediato',
              ],
