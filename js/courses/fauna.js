export const CURRICULUM = [
  {
    id: 'fau-mod-1',
    title: 'Mamíferos',
    description: 'Características, órdenes y adaptaciones de mamíferos',
    lessons: [
      {
        id: 'fau-l001',
        ...
        example: {
          title: 'Ejemplo: Definición de mamífero',
          content: `<p>Venado lacta crías; murciélago es mamífero volador.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar definición de mamífero en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre definición de mamífero.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Mamíferos alimentan crías con…',
              options: [
                'Leche materna',
                'Polen solo',
                'Rocas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Herbívoros y rumiantes',
          content: `<p>Venado rumia en bosque; conejo usa cecotrofia.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar herbívoros y rumiantes en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre herbívoros y rumiantes.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Rumiantes tienen…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Carnívoros y depredadores',
          content: `<p>Coyote omnívoro caza roedores y también come frutos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar carnívoros y depredadores en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre carnívoros y depredadores.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Depredador ápice…',
              options: [
                'Poca competencia por comerlo',
                'Solo come plantas',
                'No caza',
                'Es siempre herbívoro',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mamíferos nocturnos',
          content: `<p>Zorro usa olfato para rastrear presas en oscuridad.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mamíferos nocturnos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mamíferos nocturnos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Nocturnos suelen tener…',
              options: [
                'Ojos reflectantes y oído agudo',
                'Solo vista diurna',
                'Sin olfato',
                'Sin pelo',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Roedores',
          content: `<p>Ardilla enterradora almacena nueces para invierno.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar roedores en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre roedores.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Incisivos de roedores…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Primates',
          content: `<p>Mono aullador comunica territorio en selvas tropicales.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar primates en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre primates.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Primates destacan por…',
              options: [
                'Manos prensiles',
                'Branquias',
                'Caparazón',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Marsupiales',
          content: `<p>Canguro neonato sube al bolsa tras nacer prematuro.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar marsupiales en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre marsupiales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Marsupiales crían en…',
              options: [
                'Bolsa marsupial',
                'Nido de barro',
                'Agua salada',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mamíferos marinos',
          content: `<p>Delfín usa ecolocalización; foca tiene aletas modificadas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mamíferos marinos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mamíferos marinos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Cetáceos respiran con…',
              options: [
                'Pulmones y espiráculo',
                'Branquias',
                'Piel',
                'Raíces',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Hibernación y estivación',
          content: `<p>Marmota duerme meses con reservas de grasa acumuladas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar hibernación y estivación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre hibernación y estivación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Hibernación reduce…',
              options: [
                'Metabolismo en invierno',
                'Peso siempre',
                'Temperatura externa global',
                'Gravedad',
              ],
              correct: 0,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mamíferos de México',
          content: `<p>Jaguar es depredador ápice en selvas y manglares.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mamíferos de méxico en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mamíferos de méxico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Tlacuache es…',
  ...
  },
  {
    id: 'fau-mod-2',
    title: 'Aves',
    description: 'Anatomía, vuelo, migración e identificación ornitológica',
    lessons: [
      {
        id: 'fau-l011',
        ...
        example: {
          title: 'Ejemplo: Anatomía aviar',
          content: `<p>Huesos neumáticos reducen peso para vuelo eficiente.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar anatomía aviar en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre anatomía aviar.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Plumas sirven para…',
              options: [
                'Vuelo, aislamiento y exhibición',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Vuelo y aerodinámica',
          content: `<p>Cernícalo planea con alas fijas; colibrí bate alas rápido.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar vuelo y aerodinámica en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre vuelo y aerodinámica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Músculo principal de vuelo es…',
              options: [
                'Pectoral',
                'Glúteo',
                'Cuádriceps',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Migración',
          content: `<p>Monarca migra miles de km a oyamel mexicano.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar migración en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre migración.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Migración busca…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Cantos y comunicación',
          content: `<p>Ruiseñor canta al amanecer para marcar territorio.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar cantos y comunicación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre cantos y comunicación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Canto territorial sirve para…',
              options: [
                'Defender área y atraer pareja',
                'Fotosintetizar',
                'Digierir semillas',
                'Nadar',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Rapaces diurnas',
          content: `<p>Águila real detecta presa a gran distancia.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar rapaces diurnas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre rapaces diurnas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Rapaz diurna caza con…',
              options: [
                'Garras y vista aguda',
                'Branquias',
                'Plumas acuáticas',
                'Colmillos',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Aves nocturnas',
          content: `<p>Búho gira cabeza 270° para localizar roedores.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar aves nocturnas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre aves nocturnas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Búho localiza presa con…',
              options: [
                'Oído asimétrico',
                'Branquias',
                'Antenas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Aves acuáticas',
          content: `<p>Patos filtran comida en humedales con pico lamellado.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar aves acuáticas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre aves acuáticas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Plumas impermeables gracias a…',
              options: [
                'Aceite de glándula uropigial',
                'Clorofila',
                'Hueso denso',
                'Lignina',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Polinizadores aves',
          content: `<p>Colibrí bebe néctar y transporta polen en pico.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar polinizadores aves en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre polinizadores aves.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Colibrí poliniza flores…',
              options: [
                'Tubulares con néctar',
                'Solo subterráneas',
                'Solo acuáticas',
                'Sin néctar',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Nidificación',
          content: `<p>Golondrina usa barro; halcón falda acantilado rocoso.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar nidificación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre nidificación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Nidificación depende de…',
              options: [
                'Especie y depredadores',
                'Solo clima polar',
                'Solo océano',
                'Gravedad lunar',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Identificación por campo',
          content: `<p>Lista: tamaño de paloma, cresta roja, bosque → posible carpintero.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar identificación por campo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre identificación por campo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Identificar aves requiere…',
              options: [
                'Forma, canto y hábitat',
                'Solo olor',
                'Solo peso',
                'Solo hora exacta',
              ],
  ...
  {
    id: 'fau-mod-3',
    title: 'Reptiles, anfibios y peces',
    description: 'Vertebrados ectotermos y adaptaciones acuáticas',
    lessons: [
      {
        id: 'fau-l021',
        ...
        example: {
          title: 'Ejemplo: Reptiles: características',
          content: `<p>Lagartija toma sol para elevar temperatura corporal.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar reptiles: características en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre reptiles: características.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Reptiles regulan temperatura…',
              options: [
                'Comportamentalmente (ectotermos)',
                'Solo con pelo',
                'Con leche',
                'Con branquias',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Serpientes',
          content: `<p>Víbora de cascabel advierte con sonido de cola.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar serpientes en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre serpientes.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Serpientes detectan calor con…',
              options: [
                'Fosas loreales',
                'Branquias',
                'Plumas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Lagartos y geckos',
          content: `<p>Gecko trepa vidrio con microestructuras en dedos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar lagartos y geckos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre lagartos y geckos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Autotomía de cola sirve para…',
              options: [
                'Escapar depredador',
                'Volar',
                'Nadar',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Tortugas',
          content: `<p>Tortuga laúd anida en playas tropicales tras migración.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar tortugas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre tortugas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Caparazón es…',
              options: [
                'Estructura ósea protectora',
                'Pluma',
                'Hoja',
                'Raíz',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Cocodrilos y caimanes',
          content: `<p>Caimán acecha en orilla con solo ojos visibles.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar cocodrilos y caimanes en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre cocodrilos y caimanes.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Cocodrilos son…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Anfibios',
          content: `<p>Rana absorbe agua por piel; huevos en charca.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar anfibios en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre anfibios.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Piel permeable implica…',
              options: [
                'Sensibilidad a contaminantes',
                'Vida en desierto seco',
                'Pelo denso',
                'Plumas',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Salamandras y ajolotes',
          content: `<p>Ajolote mexicano regenera extremidades.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar salamandras y ajolotes en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre salamandras y ajolotes.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Ajolote puede…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Peces de agua dulce',
          content: `<p>Trucha prefiere agua fría oxigenada de río.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar peces de agua dulce en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre peces de agua dulce.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Branquias extraen…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Peces marinos costeros',
          content: `<p>Pez león invasor con aguijones venenosos en arrecife.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar peces marinos costeros en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre peces marinos costeros.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Vejiga natatoria controla…',
              options: [
                'Flotabilidad',
                'Color de plumas',
                'Cantidad de pelo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Amphibian decline',
          content: `<p>Ranar dorada costarricense extinta en naturaleza por hongo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar amphibian decline en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre amphibian decline.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Quitridiomicosis afecta…',
              options: [
                'Anfibios globalmente',
                'Rocas',
                'Nubes',
                'Meteoritos',
              ],
  ...
  {
    id: 'fau-mod-4',
    title: 'Insectos e invertebrados',
    description: 'Artrópodos, polinización y roles ecológicos',
    lessons: [
      {
        id: 'fau-l031',
        ...
        example: {
          title: 'Ejemplo: Anatomía del insecto',
          content: `<p>Abeja tiene antenas, alas en tórax y aguijón en hembra.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar anatomía del insecto en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre anatomía del insecto.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Insecto tiene patas…',
              options: [
                'Seis',
                'Ocho',
                'Diez',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Metamorfosis',
          content: `<p>Mariposa pasa por oruga y crisálida; langosta solo muda.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar metamorfosis en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre metamorfosis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Metamorfosis completa incluye…',
              options: [
                'Pupa',
                'Solo huevo',
                'Solo adulto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Polinizadores',
          content: `<p>Calabaza depende de abejas nativas para fruto.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar polinizadores en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre polinizadores.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Polinización produce…',
              options: [
                'Semillas y frutos',
                'Solo viento',
                'Solo agua',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Depredadores y control biológico',
          content: `<p>Liberar mariquitas reduce plaga en huerto orgánico.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar depredadores y control biológico en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre depredadores y control biológico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Mariquita come…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Insectos sociales',
          content: `<p>Colmena: reina, obreras, zánganos con roles definidos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar insectos sociales en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre insectos sociales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Colmena tiene…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Insectos acuáticos',
          content: `<p>Larva de libélula caza en charca antes de emergencia alada.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar insectos acuáticos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre insectos acuáticos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Efímera adulta vive…',
              options: [
                'Poco tiempo en aire',
                'Años solo en adulto',
                'En mar profundo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Arácnidos',
          content: `<p>Araña teje red para atrapar moscas voladoras.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar arácnidos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre arácnidos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Arácnidos tienen…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Miriápodos',
          content: `<p>Milpiés enrolla cuerpo y libera olor al molestarlo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar miriápodos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre miriápodos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Milpiés es principalmente…',
              options: [
                'Descomponedor',
                'Depredador ápice',
                'Polinizador',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Insectos vectores',
          content: `<p>Mosquito Aedes puede transmitir dengue en zonas tropicales.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar insectos vectores en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre insectos vectores.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Vector transmite…',
              options: [
                'Patógenos entre huéspedes',
                'Solo polen',
                'Solo agua',
                'Solo luz',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Conservación de insectos',
          content: `<p>Parches de flores nativas alimentan abejas urbanas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar conservación de insectos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre conservación de insectos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Ayudar polinizadores con…',
              options: [
                'Flores nativas sin pesticida',
                'Asfalto total',
                'Fuego constante',
                'Plástico en suelo',
              ],
  ...
  {
    id: 'fau-mod-5',
    title: 'Rastreo y comportamiento animal',
    description: 'Huellas, señales, etología y ética de observación',
    lessons: [
      {
        id: 'fau-l041',
        ...
        example: {
          title: 'Ejemplo: Huellas y pisadas',
          content: `<p>Huella de felino sin uñas visibles vs perro con uñas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar huellas y pisadas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre huellas y pisadas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Felino en huella muestra…',
              options: [
                'Cuatro dedos sin uñas marcadas',
                'Aletas',
                'Plumas',
                'Branquias',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Bosta y señales',
          content: `<p>Bosta de herbívoro fibrosa vs carnívoro con pelo/plumas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar bosta y señales en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre bosta y señales.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Bosta fibrosa sugiere…',
              options: [
                'Herbívoro',
                'Carnívoro estricto',
                'Pez',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Senderos y madrigueras',
          content: `<p>Sendero estrecho bajo matorral indica venado frecuente.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar senderos y madrigueras en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre senderos y madrigueras.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Sendero animal es…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Comportamiento alimenticio',
          content: `<p>Ardilla entierra nueces; halcón acecha desde percha.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar comportamiento alimenticio en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre comportamiento alimenticio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Carroñero come…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Comunicación animal',
          content: `<p>Lobo aúlla para cohesionar manada; ciervo brama en celo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar comunicación animal en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre comunicación animal.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Señal química incluye…',
              options: [
                'Feromonas y marcaje',
                'Solo colores',
                'Solo GPS',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Territorio y jerarquía',
          content: `<p>Pájaro canta en límite; ciervo lucha con astas en época reproductiva.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar territorio y jerarquía en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre territorio y jerarquía.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Territorio sirve para…',
              options: [
                'Acceso a recursos',
                'Fotosíntesis',
                'Migración solar',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Migración y estacionalidad',
          content: `<p>Oso hiberna; aves migran; ciervos mudan astas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar migración y estacionalidad en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre migración y estacionalidad.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Estacionalidad afecta…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Camuflaje y mimetismo',
          content: `<p>Insecto palo imita rama; leopardo manchado se oculta en sábana.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar camuflaje y mimetismo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre camuflaje y mimetismo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Mimetismo imita…',
              options: [
                'Objeto u organismo del entorno',
                'Sonido humano',
                'GPS',
                'Fuego',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Observación ética',
          content: `<p>Binoculares permiten observar sin estresar nido de águila.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar observación ética en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre observación ética.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'No alimentar fauna silvestre porque…',
              options: [
                'Altera comportamiento y salud',
                'Es ilegal siempre',
                'No importa',
                'Los hace volar mejor',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Registro faunístico',
          content: `<p>eBird o cuaderno: hora, canto, hábitat, número de individuos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar registro faunístico en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre registro faunístico.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Registro faunístico incluye…',
              options: [
                'Especie, lugar y fecha',
                'Solo color favorito',
                'Nada',
                'Solo olor',
              ],
