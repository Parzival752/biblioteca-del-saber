export const CURRICULUM = [
  {
    id: 'bio-mod-1',
    title: 'Células y fundamentos de la vida',
    description: 'Estructura celular, metabolismo y organización biológica',
    lessons: [
      {
        id: 'bio-l001',
        ...
        example: {
          title: 'Ejemplo: ¿Qué es la biología?',
          content: `<p>Al identificar una planta en una caminata aplicas taxonomía y ecología sin laboratorio.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar ¿qué es la biología? en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ¿qué es la biología?.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué estudia la biología?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Células procariotas',
          content: `<p>En un gramo de suelo fértil hay miles de millones de bacterias descomponiendo materia orgánica.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar células procariotas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre células procariotas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué caracteriza a una procariota?',
              options: [
                'ADN sin núcleo delimitado',
                'Núcleo con doble membrana',
                'Cloroplastos',
                'Vacuola central gigante',
              ],
              correct: 0,
            },
          ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Células eucariotas',
          content: `<p>La célula de una hoja tiene cloroplastos; la muscular tiene muchas mitocondrias.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar células eucariotas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre células eucariotas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué organelo produce la mayor parte del ATP?',
              options: [
                'Mitocondria',
                'Nucleolo',
                'Pared celular',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Membrana y transporte celular',
          content: `<p>Regar con agua muy salina marchita una planta porque el agua sale de las células por ósmosis.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar membrana y transporte celular en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre membrana y transporte celular.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué es la ósmosis?',
              options: [
                'Difusión de agua por membrana',
                'División celular',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Metabolismo celular',
          content: `<p>Al esprintar, tus músculos demandan ATP rápidamente vía respiración aeróbica.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar metabolismo celular en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre metabolismo celular.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dónde ocurre la respiración aeróbica?',
              options: [
                'Mitocondria',
                'Núcleo',
                'Cloroplasto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mitosis',
          content: `<p>Tras un corte, células de la piel se dividen por mitosis para reparar el tejido.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mitosis en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mitosis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Para qué sirve principalmente la mitosis?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Meiosis',
          content: `<p>Hermanos comparten ADN parcial pero la meiosis crea combinaciones únicas en cada gameto.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar meiosis en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre meiosis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Cuántas divisiones tiene la meiosis?',
              options: [
                'Dos',
                'Una',
                'Tres',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Niveles de organización biológica',
          content: `<p>El oxígeno que respiras proviene de cloroplastos en hojas que forman el dosel de un bosque.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar niveles de organización biológica en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre niveles de organización biológica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué nivel incluye varias especies interactuando?',
              options: [
                'Comunidad',
                'Población',
                'Organelo',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Homeostasis',
          content: `<p>En frío intenso tu cuerpo reduce flujo periférico y aumenta metabolismo para conservar 37 °C.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar homeostasis en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre homeostasis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Microscopía y observación',
          content: `<p>Con una lupa 10× ves estomas, venas y pequeños artrópodos en una hoja.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar microscopía y observación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre microscopía y observación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Para qué sirve la tinción?',
              options: [
                'Aumentar contraste de estructuras',
                'Matizar la muestra',
                'Enfriar el equipo',
                'Medir pH',
              ],
  ...
  },
  {
    ...
    description: 'Estructura del ADN, expresión génica e herencia',
    lessons: [
      {
        id: 'bio-l011',
        ...
        example: {
          title: 'Ejemplo: Estructura del ADN',
          content: `<p>Cada cadena sirve de molde durante la replicación semiconservativa.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar estructura del adn en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre estructura del adn.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Con qué se empareja la adenina?',
              options: [
                'Timina',
                'Citosina',
                'Guanina',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Genes y cromosomas',
          content: `<p>El color de ojos depende de varios alelos que se combinan en cada individuo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar genes y cromosomas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre genes y cromosomas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué es un alelo?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Replicación del ADN',
          content: `<p>Antes de mitosis cada cromosoma se duplica para que las hijas reciban información completa.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar replicación del adn en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre replicación del adn.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué enzima sintetiza ADN?',
              options: [
                'ADN polimerasa',
                'Amilasa',
                'Lipasa',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Transcripción y traducción',
          content: `<p>El gen de lactasa produce la enzima que digiere lactosa en el intestino.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar transcripción y traducción en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre transcripción y traducción.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dónde ocurre la traducción?',
              options: [
                'Ribosoma',
                'Núcleo',
                'Lisosoma',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Herencia mendeliana',
          content: `<p>Cruzando guisantes amarillos (AA) con verdes (aa) la F1 es toda amarilla (Aa).</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar herencia mendeliana en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre herencia mendeliana.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Un individuo Aa es…',
              options: [
                'Heterocigoto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Herencia ligada al sexo',
          content: `<p>Machos pueden expresar daltonismo con un solo alelo recesivo en el X.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar herencia ligada al sexo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre herencia ligada al sexo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Quién expresa recesivo del X más fácil?',
              options: [
                'Machos XY',
                'Hembras XX',
                'Ambos igual',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Mutaciones',
          content: `<p>La UV forma dímeros de timina; reparación fallida puede derivar en cáncer de piel.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar mutaciones en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre mutaciones.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué es una mutación?',
              options: [
                'Cambio en secuencia de ADN',
                'Cambio de estación',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ingeniería genética',
          content: `<p>Bacterias con gen humano de insulina producen hormona para diabéticos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar ingeniería genética en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ingeniería genética.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué hace la PCR?',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Epigenética',
          content: `<p>Oruga y mariposa comparten genoma pero activan genes distintos según desarrollo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar epigenética en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre epigenética.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La epigenética modifica…',
              options: [
                'Expresión sin cambiar secuencia',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Genética de poblaciones',
          content: `<p>Un cuello de botella puede fijar alelos raros en una población pequeña.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar genética de poblaciones en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre genética de poblaciones.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué reduce diversidad genética?',
              options: [
                'Cuello de botella',
                'Migración amplia',
                'Población grande',
                'Muchas mutaciones neutras',
              ],
              correct: 0,
            },
          ],
  ...
  },
  {
    ...
    description: 'Selección natural, especiación y evidencias evolutivas',
    lessons: [
      {
        id: 'bio-l021',
        ...
        example: {
          title: 'Ejemplo: Selección natural',
          content: `<p>Un insecto verde en follaje tiene más supervivencia que uno de color llamativo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar selección natural en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre selección natural.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Qué impulsa la selección natural?',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Adaptaciones morfológicas',
          content: `<p>Las agujas del pino reducen pérdida de agua frente a hojas anchas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar adaptaciones morfológicas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre adaptaciones morfológicas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Una adaptación es…',
              options: [
                'Rasgo que mejora supervivencia',
                'Cualquier mutación',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Especiación',
          content: `<p>Islas pueden aislar poblaciones que evolucionan cantos distintos en aves.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar especiación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre especiación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La especiación forma…',
              options: [
                'Nuevas especies',
                'Nuevos átomos',
                'Nuevos planetas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Registro fósil',
          content: `<p>Fósiles de Archaeopteryx muestran rasgos de reptiles y aves.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar registro fósil en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre registro fósil.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Los fósiles evidencian…',
              options: [
                'Cambio de especies en el tiempo',
                'Edad de montañas solamente',
                'Solo dinosaurios',
                'Clima actual',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          ...
          content: `<p>ADN compartido entre humanos y chimpancés refleja ancestro común reciente.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar filogenia en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre filogenia.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Un árbol filogenético muestra…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Coevolución',
          content: `<p>Orquídeas y polinizadores especializados evolucionan formas complementarias.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar coevolución en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre coevolución.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Coevolución implica…',
              options: [
                'Cambios recíprocos entre especies',
                'Evolución de rocas',
                'Solo competencia',
                'Clima estático',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Evolución humana',
          content: `<p>Fósiles de Australopithecus muestran pelvis adaptada a caminar erguido.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar evolución humana en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre evolución humana.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Bipedestación es…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Resistencia antibiótica',
          content: `<p>Uso excesivo de antibióticos selecciona cepas resistentes en hospitales.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar resistencia antibiótica en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre resistencia antibiótica.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La resistencia antibiótica es…',
              options: [
                'Selección natural en bacterias',
                'Mutación de rocas',
                'Efecto lunar',
                'Fotosíntesis',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Extinciones masivas',
          content: `<p>Tras extinción del Cretácico proliferaron mamíferos diversos.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar extinciones masivas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre extinciones masivas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Una extinción masiva…',
              options: [
                'Elimina muchas especies rápidamente',
                'Crea ADN nuevo',
                'Detiene evolución para siempre',
                'Solo afecta plantas',
              ],
              correct: 0,
            },
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Evolución observada',
          content: `<p>Mariposas industriales oscurecieron su color con la contaminación en Inglaterra.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar evolución observada en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre evolución observada.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Dónde se observó evolución rápida clásica?',
              options: [
                'Mariposa del abedul',
                'En la Luna',
  ...
  },
  {
    ...
    description: 'Sistemas del cuerpo humano y su función integrada',
    lessons: [
      {
        id: 'bio-l031',
        ...
        example: {
          title: 'Ejemplo: Sistema esquelético',
          content: `<p>La caja torácica protege corazón y pulmones; la columna permite flexión.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema esquelético en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema esquelético.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'El esqueleto permite…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema muscular',
          content: `<p>Flexionar el brazo acorta el bíceps mientras el tríceps se estira.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema muscular en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema muscular.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Los músculos necesitan…',
              options: [
                'ATP para contraerse',
                'Luz solar directa',
                'Clorofila',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema circulatorio',
          content: `<p>El corazón bombea sangre oxigenada desde pulmones al resto del cuerpo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema circulatorio en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema circulatorio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'El corazón bombea…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema respiratorio',
          content: `<p>Tras subir montaña puedes sentir falta de aire por menor presión parcial de O₂.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema respiratorio en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema respiratorio.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'El intercambio gaseoso ocurre en…',
              options: [
                'Alvéolos',
                'Estómago',
                'Riñones',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema digestivo',
          content: `<p>Enzimas en páncreas e intestino degradan carbohidratos, proteínas y grasas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema digestivo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema digestivo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La absorción principal ocurre en…',
              options: [
                'Intestino delgado',
                'Esófago',
                'Uñas',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema nervioso',
          content: `<p>Retirar la mano del fuego es un reflejo medido por médula y nervios.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema nervioso en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema nervioso.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La unidad básica nerviosa es…',
              options: [
                'Neurona',
                'Glóbulo rojo',
                'Osteoblasto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema endocrino',
          content: `<p>Adrenalina acelera pulso y respiración en situaciones de peligro.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema endocrino en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema endocrino.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Las hormonas viajan principalmente en…',
              options: [
                'Sangre',
                'Aire pulmonar',
                'Hueso compacto',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema inmune',
          content: `<p>Vacunas entrenan linfocitos de memoria sin enfermedad grave.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema inmune en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema inmune.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La inmunidad adaptativa tiene…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Sistema excretor',
          content: `<p>Orinar concentra urea cuando bebes poca agua en calor extremo.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar sistema excretor en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre sistema excretor.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Los riñones eliminan…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Piel y termorregulación',
          content: `<p>Sudar en calor y erizarse en frío son respuestas de termorregulación.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar piel y termorregulación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre piel y termorregulación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'La piel ayuda a…',
  ...
  {
    id: 'bio-mod-5',
    title: 'Ecología, microbiología y campo',
    description: 'Ecosistemas, microorganismos y práctica de biología de campo',
    lessons: [
      {
        id: 'bio-l041',
        ...
        example: {
          title: 'Ejemplo: Cadenas y redes tróficas',
          content: `<p>Hierba → conejo → zorro → descomponedores; energía disminuye en cada nivel.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar cadenas y redes tróficas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre cadenas y redes tróficas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: '¿Quién produce alimento con fotosíntesis?',
              options: [
                'Productores (plantas)',
                'Depredadores ápice',
                'Hongos solamente',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ciclos biogeoquímicos',
          content: `<p>Bacterias nitrificantes convierten amonio en nitratos usables por plantas.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar ciclos biogeoquímicos en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ciclos biogeoquímicos.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'El ciclo del carbono incluye…',
              options: [
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Biomas terrestres',
          content: `<p>Taiga tiene coníferas y inviernos largos; sabana tiene estaciones secas y herbívoros.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar biomas terrestres en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre biomas terrestres.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Un bioma se define por…',
              options: [
                'Clima y comunidades típicas',
                'Un solo árbol',
                'Un día específico',
                'Un mineral',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Bacterias beneficiosas',
          content: `<p>Yogurt y chucrut dependen de fermentación bacteriana controlada.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar bacterias beneficiosas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre bacterias beneficiosas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Bacterias del intestino ayudan a…',
              options: [
                'Digestión y defensa',
                'Fotosíntesis',
                'Volar',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Virus y vacunas',
          content: `<p>Vacunas de ARNm instruyen células a producir proteínas virales para entrenar inmunidad.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar virus y vacunas en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre virus y vacunas.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Un virus necesita…',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Hongos y descomposición',
          content: `<p>Setas en tronco caído indican descomposición activa de madera.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar hongos y descomposición en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre hongos y descomposición.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Los hongos saprófitos…',
              options: [
                'Descomponen materia muerta',
                'Hacen fotosíntesis',
                'Cazan mamíferos',
                'Nadan en océano',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Simbiosis',
          content: `<p>Micorrizas conectan raíces con hifas que absorben fósforo a cambio de azúcares.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar simbiosis en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre simbiosis.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Mutualismo implica…',
              options: [
                'Beneficio para ambos',
                'Daño a ambos',
                'Beneficio solo al parásito',
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Método científico en campo',
          content: `<p>Contar aves en transecto semanal revela cambios estacionales de abundancia.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar método científico en campo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre método científico en campo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Una hipótesis debe ser…',
              options: [
                'Falsable y comprobable',
                'Imposible de probar',
                'Solo opinión',
                'Secreta',
              ],
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Muestreo y cuaderno de campo',
          content: `<p>Cuaderno: fecha, coordenadas, clima, especie, comportamiento y foto georreferenciada.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar muestreo y cuaderno de campo en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre muestreo y cuaderno de campo.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Un cuaderno de campo debe incluir…',
              options: [
                'Fecha, lugar y observaciones',
                'Solo dibujos sin datos',
                'Nada escrito',
                'Solo clima',
              ],
              correct: 0,
      ...
      },
      {
        ...
        example: {
          title: 'Ejemplo: Ética y conservación',
          content: `<p>No recolectes especies raras; fotografía y deja el sitio como lo encontraste.</p>`,
          tip: 'Anota fecha, lugar y condiciones al practicar ética y conservación en campo.',
        },
        exercise: {
          instructions: 'Comprueba lo aprendido sobre ética y conservación.',
          hint: 'Repasa el concepto central de la lección.',
          questions: [
            {
              q: 'Al observar en naturaleza debes…',
              options: [
                'Minimizar impacto',
                'Capturar todo',
